...
router.post('/doAddIdea',async(req, res, next) => {
    ...
    if ((formatCurrDate >= formatStartDate && formatCurrDate <= formatEndDate ) )
    {
        ...
        res.render('coordinator/allFileSubmit', { startDate: finalStartDate2, endDate: finalEndDate2, 
...
router.post('/doAddFile', async function(req, res, next) {
    ...
    form.parse(req, async function (err, fields, files) {
        ...
        res.render('coordinator/allFileSubmit', { implementSuccess: "File added" })
    })
...
router.get('/allFileSubmit',async (req, res) => {
    ...
    res.render('coordinator/allFileSubmit',{ viewCategory: result, getDate: getDate, getUser: newValues[0]});
})
...
router.get('/viewAll',async (req, res) => {
    ...
    res.render('coordinator/seeIdea',{ viewAllIdea: result});
...
router.get('/allFileSubmit',async (req, res) => {
    ...
    const newValues = await dbHandler.getUser("users",req.session.user.email);
    console.log(newValues);
    res.render('coordinator/allFileSubmit',{ viewCategory: result, getUser: newValues[0]});
})
...
router.get('/viewIdea', async (req, res) => {
    ...
    res.render('coordinator/viewDetail', { 
